...
if __name__ == '__main__':
    ...
    print('Lista de 5 números aleatorios del intervalo [1,6]: ', lista_numeros)
    ...
    # print(cantidad_tres)
    print(f'El 3 se repite {cantidad_tres} veces, en la lista generada aleatoriamente' )
